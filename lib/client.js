...
function DeployCard(props) {
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      ...
      st?.installing ? import_react.default.createElement("span", { style: { fontSize: "11px", fontWeight: 600, color: "var(--dsw-alias-state-warn-primary)" } }, t("deploy.installing")) : import_react.default.createElement(
        "button",
        {
...
function ProtectCard(props) {
  ...
  const [builtin, setBuiltin] = (0, import_react.useState)(null);
  const [builtinNote, setBuiltinNote] = (0, import_react.useState)(null);
  const [prefix, setPrefix] = (0, import_react.useState)("/deepseek");
  const load = (0, import_react.useCallback)(async () => {
    try {
  ...
  const addBuiltin = async () => {
    ...
    try {
      ...
      setBuiltinNote({
        ok: true,
        text: d.action === "noop" ? t("protect.noop") : t("protect.builtinDone", { name: d.display_name || d.provider, models: d.models ?? 0 })
      });
    } catch (e) {
...
function ExemptionCard(props) {
  ...
  return import_react.default.createElement(
    ...
    !online && import_react.default.createElement("div", { style: { ...dim, color: "var(--dsw-alias-state-warn-primary)" } }, t("exempt.apiDownHint")),
...
function Panel(props) {
  ...
  return import_react.default.createElement(
    ...
    error ? import_react.default.createElement("div", { style: { ...dim, marginTop: "10px", color: "var(--dsw-alias-state-error-primary)" } }, error) : null
  );
}
function apply(ctx) {
